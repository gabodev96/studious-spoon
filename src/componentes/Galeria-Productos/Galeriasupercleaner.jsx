...
export const Galeriasupercleaner = () => {
  const [data, setData] = useState([]);
  let filtrados = prodVelas;

  let filtradosArray = filtrados.filter((e) => e.supercleaner === true);
    ...
    <div className="pb-10 lg:pb-36">
      ...
      <AnimatedPage>
        <div className="container pt-2 ">
          <div className="flex flex-wrap gap-1 lg:after:w-2/3 justify-center  lg:justify-center">
            {data.map((products) => (
              <div
              ...
              >
                ...
                >
                  ...
                  <div className="textol lg:opacity-0   top-50  mt-28 p-1 font-bold font-baloo">
                    {products.tipo}
                  </div>
                </Link>
              </div>
